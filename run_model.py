...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str,
                        default='xunfei', help='the name of dataset')
    ...
    parser.add_argument('--ind', type=int, default=-1, help='select index in K-fold')
    parser.add_argument("--loss", type=str, default='mse')
    parser.add_argument("--rnn_units", type=int, default=128)
    parser.add_argument("--embed_dim", type=int, default=30)
    parser.add_argument("--cheb_order", type=int, default=4)
    parser.add_argument("--num_layers", type=int, default=2)
    parser.add_argument("--graph_type", type=str, default='geo')
    parser.add_argument("--dtw_topk", type=int, default=10)
    parser.add_argument("--add_apt", type=str2bool, default=True)
    parser.add_argument("--use_cl", type=str2bool, default=False)
